...
const 不要的 = [
  ...
  // 【2026-09-17 补】这三份在 .gitignore 里早就不进公开仓库（2026-09-04 定的），
  // 但这张表漏了它们：本机装配的发布包、以及运行时现打的「源码包」都会把它们带出去，
  // 而其中写着内网地址与本机路径。
  { 名: "NEXT-SESSION-PROMPT.md", 为什么: "内部工作笔记，不是源码，也不进公开仓库（见 .gitignore）" },
  { 名: "RESTRUCTURE-PLAN.md", 为什么: "内部工作笔记，不是源码，也不进公开仓库（见 .gitignore）" },
  { 名: "report.html", 为什么: "内部工作笔记，不是源码，也不进公开仓库（见 .gitignore）" },
];
